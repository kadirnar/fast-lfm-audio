...
| --- | --- | --- | --- |
| Transformers | 5.16.0.dev0 | 3.13.14 | 2.55 |
| vLLM | 0.29.0 | 3.13.14 | 24.18 |
| SGLang | 0.5.19 | 3.12.13 | 18.67 |
...
| --- | --- | --- | --- |
| 5 s | **0.513 s**<br><sub>5.04 s audio (capped)</sub> | **0.578 s**<br><sub>5.04 s audio (capped)</sub> | **0.556 s**<br><sub>5.04 s audio (capped)</sub> |
| 20 s | **2.010 s**<br><sub>20.00 s audio (capped)</sub> | **2.258 s**<br><sub>20.00 s audio (capped)</sub> | **2.133 s**<br><sub>20.00 s audio (capped)</sub> |
| 100 s | **10.029 s**<br><sub>100.00 s audio (capped)</sub> | **11.364 s**<br><sub>100.00 s audio (capped)</sub> | **10.851 s**<br><sub>100.00 s audio (capped)</sub> |

## Voice Chat

| Input Audio | Transformers | vLLM | SGLang |
| --- | --- | --- | --- |
| 5 s | **1.544 s**<br><sub>13.76 s audio</sub> | **1.418 s**<br><sub>10.72 s audio</sub> | **4.196 s**<br><sub>36.80 s audio (capped)</sub> |
| 20 s | **3.911 s**<br><sub>36.88 s audio (capped)</sub> | **4.421 s**<br><sub>36.32 s audio (capped)</sub> | **4.276 s**<br><sub>37.12 s audio (capped)</sub> |
| 100 s | **2.523 s**<br><sub>21.60 s audio</sub> | **4.254 s**<br><sub>32.64 s audio (capped)</sub> | **2.930 s**<br><sub>19.76 s audio</sub> |
