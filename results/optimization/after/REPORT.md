...
| --- | --- | --- | --- |
| Transformers | 5.16.0.dev0 | 3.13.14 | 1.72 |
| vLLM | 0.29.0 | 3.13.14 | 17.02 |
| SGLang | 0.5.19 | 3.12.13 | 20.10 |
...
| --- | --- | --- | --- |
| 5 s | **0.406 s**<br><sub>5.04 s audio (capped)</sub> | **0.477 s**<br><sub>5.04 s audio (capped)</sub> | **0.454 s**<br><sub>5.04 s audio (capped)</sub> |
| 20 s | **1.587 s**<br><sub>20.00 s audio (capped)</sub> | **1.854 s**<br><sub>20.00 s audio (capped)</sub> | **1.725 s**<br><sub>20.00 s audio (capped)</sub> |
| 100 s | **7.907 s**<br><sub>100.00 s audio (capped)</sub> | **9.248 s**<br><sub>100.00 s audio (capped)</sub> | **8.519 s**<br><sub>100.00 s audio (capped)</sub> |

## Voice Chat

| Input Audio | Transformers | vLLM | SGLang |
| --- | --- | --- | --- |
| 5 s | **1.248 s**<br><sub>13.76 s audio</sub> | **1.186 s**<br><sub>10.72 s audio</sub> | **3.332 s**<br><sub>36.80 s audio (capped)</sub> |
| 20 s | **3.126 s**<br><sub>36.88 s audio (capped)</sub> | **3.631 s**<br><sub>36.32 s audio (capped)</sub> | **3.399 s**<br><sub>37.12 s audio (capped)</sub> |
| 100 s | **2.059 s**<br><sub>21.60 s audio</sub> | **3.548 s**<br><sub>32.64 s audio (capped)</sub> | **2.404 s**<br><sub>19.76 s audio</sub> |
